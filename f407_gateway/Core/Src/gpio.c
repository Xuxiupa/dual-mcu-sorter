...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, LED0_Pin|LED1_Pin|W25Q64_MOSI_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(W25Q64_SCK_GPIO_Port, W25Q64_SCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : W25Q64_SCK_Pin */
  GPIO_InitStruct.Pin = W25Q64_SCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(W25Q64_SCK_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : W25Q64_MISO_Pin */
  GPIO_InitStruct.Pin = W25Q64_MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(W25Q64_MISO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : W25Q64_MOSI_Pin */
  GPIO_InitStruct.Pin = W25Q64_MOSI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(W25Q64_MOSI_GPIO_Port, &GPIO_InitStruct);
