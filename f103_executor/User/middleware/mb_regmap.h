...
#define BIT_RECHECK_OK       0x0010   /* PB1 反射红外复检通过: 物料确认在分拣位 */
#define BIT_RECHECK_FAIL     0x0020   /* PB1 反射红外复检未通过: 疑似误触发(PA12 可能误动) */
...
#define POST_ALL            0x000F   /* ADC+电机+编码器+舵机 四项全过    */
